...
- Advisor already working with one family through invited path (JRN-ADV-002)
...
**Advisor State:**
- Advisor already has active account through invited path (JRN-ADV-002)
...
> - **New Independent Advisors**: Follow all stages 1-12 sequentially
> - **Converting Invited Advisors**: Skip Stages 1-2 (account already exists from JRN-ADV-002), must complete Stages 3-6 (professional profile building with pre-filled basic data), then proceed to **Stage 7: KYC Verification**
...
- **Marketing System**: Provides compelling value proposition and social proof
...
- **Verification Provider (Third-Party)**: Performs document and face matching
...
**Integration Points:**
- **Stripe Connect**: Managed onboarding and payment processing
- **Webhook Handler**: Processes Stripe onboarding status updates

**Responsible Roles:**
- **Advisor**: Provides financial information
- **Stripe Connect**: Processes payment onboarding and verification

---

### Stage 10: Moderation & Quality Review [only related to Advisor Portal]
...
**Responsible Roles:**
- **Marketplace Service**: Publishes profile and enables discovery
- **Search Engine**: Indexes profile for family searches
- **Analytics Service**: Tracks profile performance metrics
